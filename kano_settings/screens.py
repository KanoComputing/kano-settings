...
SCREENS = ScreenCollection([
    ...
    Screen('mouse', _("Mouse"), SetMouse, screen_no=1, setting_param='Mouse'),
    Screen('audio', _("Audio"), SetAudio, screen_no=2, setting_param='Audio'),
    Screen('display', _("Display"), SetDisplay, screen_no=3),
    Screen('wifi', _("WiFi"), SetWifi, screen_no=4),
    Screen('bluetooth', _("Bluetooth"), BluetoothConfig,
           on_home_screen=is_bluetooth_available()),
    Screen('overclocking', _("Overclocking"), SetOverclock, screen_no=5,
           setting_param='Overclocking'),
    Screen('account', _("Account"), SetAccount, screen_no=6),
    Screen('appearance', _("Style"), SetStyle, screen_no=7,
           on_home_screen=os.environ.get('DESKTOP_MODE'),
           setting_param='Wallpaper'),
    Screen('font', _("Font"), SetFont, screen_no=8, setting_param='Font'),
    Screen('advanced', _("Advanced"), SetAdvanced, screen_no=9),
    Screen('about', _("About"), SetAbout, screen_no=10),
    Screen('notifications', _("Notifications"), SetNotifications, screen_no=11),
    Screen('no-internet', _("No-internet"), NoInternet, screen_no=12,
